    ...
    <form id="formReceita" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span3" style="margin-left: 0;">
                ...
                <select id="options_n" class="span12">
                    <option value="" selected>-- Selecione uma opção --</option>
                    <option value="Taxa da maquineta">Taxa da maquineta</option>
                    <option value="Compra de peças">Compra de peças</option>
                    <option value="Venda de peças">Venda de peças</option>
                    <option value="Pagamento Motoboy">Pagamento Motoboy</option>
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span6" style="margin-left: 0">
                    <div class="span6" style="margin-left: 20px">
                        <label for="recebido">Pago/Recebido?</label>
                        <input id="recebido" type="checkbox" name="recebido" value="1" />
                    </div>
                </div>

                <div id="divRecebimento" class="span10" style="display: none; margin-left: 0">
                    <div class="span6" style="margin-left: 0">
                        <label for="recebimento">Data Receb./Pagam.</label>
                    ...
                    <div class="span6" style="margin-left: 0">
                        ...
                        <select name="qtdparcelas" id="qtdparcelas" class="span8">
...
<div id="modalReceitaParcelada" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formReceita_parc" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita_parc" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span3" style="margin-left: 0;">
                <label for="descricao">Selecione:</label>
                <select id="options_p" class="span12">
                    <option value="" selected>-- Selecione uma opção --</option>
                    <option value="Taxa da maquineta">Taxa da maquineta</option>
                    <option value="Compra de peças">Compra de peças</option>
                    <option value="Venda de peças">Venda de peças</option>
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4" style="margin-left: 0">
                    <label for="formaPgto_parc">Forma de Pagamento</label>
...
<div id="modalEditar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formEditar" action="<?php echo base_url() ?>index.php/financeiro/editar" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0;">
                <label for="descricao">Selecione:</label>
                <select id="options_e" class="span12">
                    <option value="" selected>-- Selecione uma opção --</option>
                    <option value="Taxa da maquineta">Taxa da maquineta</option>
                    <option value="Compra de peças">Compra de peças</option>
                    <option value="Venda de peças">Venda de peças</option>
            ...
            <div class="span12" style="margin-left: 0">
                <div class="span4" style="margin-left: 0">
                    <label for="pago">Foi Recebido/Pago?</label>
                ...
                <div id="divPagamentoEditar" class="span8" style=" display: none">
                    <div class="span6">
                        <label for="pagamento">Data Receb./Pagam.</label>
...
<script type="text/javascript">
    // Modificado por Nícolas R.
    function attDescricao() {
        document.getElementById('options_n').addEventListener('change', function() {
            var selectedOption = this.value;
            document.getElementById('descricao').value = selectedOption;
        });
        document.getElementById('options_p').addEventListener('change', function() {
            var selectedOption = this.value;
            document.getElementById('descricao_parc').value = selectedOption;
        });
        document.getElementById('options_e').addEventListener('change', function() {
            var selectedOption = this.value;
            document.getElementById('descricaoEditar').value = selectedOption;
        });
    }
    window.onload = attDescricao;
    // Modificado por Nícolas R.
